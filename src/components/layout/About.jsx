		...
		<>
			<HeaderAnimation>
				<div className="py-20 flex flex-col" id="header">
					<header className=" text-white min-h-[100vh] flex flex-col gap-10 w-full">
						<div className="flex flex-col lg:flex-row w-full min-h-[30vh] justify-center md:items-center lg:items-center lg:justify-start">
						...
						<div className="w-full flex justify-center items-center">
							<div className="flex flex-col lg:flex-row md:px-[85px] lg:p-0">
								<div className="w-[100%]">
									...
									{/* Flecha que solo se muestra en pantallas grandes */}
									<span className="text-[30px] text-lime-600 p-5 h-[270px] w-full flex transition duration-300 flex-col justify-center items-center hidden lg:flex">
										⭢
									</span>
								</div>
								<div className="w-[100%]">
					...
					<section id="#about" className="text-white min-h-[100vh] w-full flex flex-col items-center justify-center">
						{/* Content Section */}
						<div className="flex w-full items-center flex-col lg:flex-row">
							...
							<div className="w-[70%] lg:w-[50%] flex gap-5 flex-col justify-center lg:justify-start">
								<h1 className="font-flory text-[40px] w-full text-center lg:text-start">
						...
						<div className="w-full flex justify-center lg:justify-end">
							...
							<span className="text-[30px] text-lime-600 p-5 h-[220px] w-[50%] flex transition duration-300 flex-col justify-center items-center hidden lg:flex">
								⭢
							</span>
							<div className="w-[100%] md:w-[77%] lg:w-[49.9%]">
								<p className="py-4 lg:p-0 flex flex-col gap-5 font-light text-base md:text-lg lg:text-[18px] leading-relaxedvw-full">
					...
					<section id="#about" className="text-white min-h-[50vh] w-full flex flex-col justify-center items-center relative ">
						{/* Content Section */}
						<div className="flex text-center justify-center items-center w-full">
							<h1 className="text-[70px] w-[60%] font-bolddec flex border-b-2 border-zinc-800 justify-center text-lime-600 items-center">Extra</h1>
						</div>
